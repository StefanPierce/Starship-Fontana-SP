 ...
 */
enum SFEVENT {SFEVENT_NULL, SFEVENT_QUIT, SFEVENT_UPDATE, SFEVENT_PLAYER_LEFT, SFEVENT_PLAYER_RIGHT, SFEVENT_FIRE, SFEVENT_COLLISION, SFEVENT_PLAYER_UP, SFEVENT_PLAYER_DOWN, SFEVENT_LAST, SFEVENT_PLAYER_DOWN_RELEASED, SFEVENT_PLAYER_LEFT_RELEASED, SFEVENT_PLAYER_RIGHT_RELEASED, SFEVENT_PLAYER_UP_RELEASED, SFEVENT_FIRE_RELEASED, SFEVENT_LWALL, SFEVENT_RWALL};
